...
class PrepaidUser extends PersistableObject {
    ...
    function  __construct() {
        ...
        $this->properties['agent'] = new Property('agent', '', true, IndexType::Normal);
    ...
    public static function GetDSN() {
        return PersistenceManager::getDSN_UserName().'genesisville.prepaid_users';
    }
}
?>
