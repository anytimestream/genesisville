<?php
class Station extends PersistableObject {
    ...
    function  __construct() {
        ...
        $this->properties['accept_prepaid_order'] = new Property('accept_prepaid_order', 0, true, IndexType::Normal);
    ...
    public static function GetDSN() {
        return PersistenceManager::getDSN_UserName().'genesisville.stations';
    }
