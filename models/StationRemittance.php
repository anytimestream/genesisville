<?php
class StationRemittance extends PersistableObject {

    function  __construct() {
        //Persistable Data Members
        $this->properties['id'] = new Property('id', 'station_remittance_'.uniqid(), true, IndexType::PrimaryKey);
    ...
    public static function GetDSN() {
        return PersistenceManager::getDSN_UserName().'genesisville.station_remittance';
    }
