...
<html>
    <head>
        ...
        <title>Plantation City | Orders</title>
    ...
    <body id="orders">
        ...
        <div id="content">
            <ul class="tab">
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/plantation-city/orders">Orders</a></li>
                <li><a href="<?php echo CONTEXT_PATH; ?>/backend/plantation-city/users">Users</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_orders">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/orders?action=new" title="New Order">New</a>
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/orders?action=update" title="Edit Order">Edit</a>
                    <a class="btn" execute="print_ticket" href="<?php echo CONTEXT_PATH ?>/plantation-city/prepaid/orders?action=print" title="Print">Print</a>
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/orders?action=summary&<?php echo $_GET['url_search'] ?>" title="<?php echo $_GET['summary_url'] ?>">Summary</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/orders?action=reload" title="Reload Orders">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1600px;">
                        <div class=th>
                            ...
                            <span class="td w80" name="state" dataColumn="DataColumnSelect" dataSource="_state" style="text-align:center">Plan Status</span>
                            <span class="td w80" style="text-align:center">Amount</span>
                            <span class="td w80" style="text-align:center">Duration</span>
                            <span class="td w80" name="expires" dataColumn="DataColumnTextbox" validation="Date" style="text-align:center">Plan Expiry</span>
