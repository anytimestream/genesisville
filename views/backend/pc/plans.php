...
<html>
    <head>
        ...
        <title>Plantation City | Plans</title>
    ...
    <body id="plans">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/plantation-city/plans">Plans</a></li>
            </ul>
            <div class="normosa-ui-datatable" id="datatable_plans">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/plans?action=new" title="New Plan">New</a>
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/plans?action=update" title="Edit Plan">Edit</a>
                    <a class="btn" action="delete" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/plans?action=delete" title="Delete Plan">Delete</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/plantation-city/plans?action=reload" title="Reload Plan">Reload</a>
