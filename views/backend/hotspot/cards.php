    ...
    <body id="cards">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/cards">Cards</a></li>
            </ul>
            <div class="normosa-ui-datatable" id="datatable_cards">
                <div class="toolbar">  
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/cards?action=reload" title="Reload Card">Reload</a>
                    <a class="fullscreen" action="fullscreen" title="Toggle FullScreen"></a>
                    <form id=card_upload method=post style="margin-top: 1px;" enctype="multipart/form-data">
                        <select class="textbox h23 w150" id="plan" name="plan">
                            <?php
                            $plans = $_GET['plans'];
                            for ($i = 0; $i < $plans->count(); $i++) {
                                ?>
                                <option><?php echo $plans[$i]->getValue('name') ?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w120" style="text-align:center">Username</span>
                            <span class="td w120" style="text-align:center">Status</span>
