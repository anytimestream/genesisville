...
<html>
    ...
    <body id="orders">
        ...
        <div id="content">
            <ul class="tab">
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/orders">Orders</a></li>
                <li><a href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/pending-orders">Pending Orders</a></li>
                <li><a href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/plans">Plans</a></li>
                <li><a href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/cards">Cards</a></li>
            </ul>
            <div class="normosa-ui-datatable" id="datatable_orders">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/orders?action=summary&<?php echo $_GET['url_search'] ?>" title="<?php echo $_GET['summary_url'] ?>">Summary</a>
                    <a class="btn" execute="send_sms" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/orders?action=send-sms" title="Send SMS">Send SMS</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/orders?action=reload" title="Reload Plan">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w120" style="text-align:center">Transaction Ref</span>
                            <span class="td w120" style="text-align:center">Plan</span>
                            <span class="td w80" style="text-align:center">Phone</span>
                            <span class="td w150" style="text-align:center">Email</span>
                            <span class="td w80" style="text-align:center">Amount</span>
                            <span class="td w100" style="text-align:center">GTPay R. Code</span>
                            <span class="td w150" style="text-align:center">GTPay Response</span>
                            <span class="td w120" style="text-align:center">GTPay TR</span>
