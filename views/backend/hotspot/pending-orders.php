...
<html>
    <head>
        ...
        <title>Hotspot | Pending Orders</title>
    ...
    <body id="orders">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/hotspot/pending-orders">Pending Orders</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_orders">
                <div class="toolbar">
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/pending-orders?action=reload" title="Reload">Reload</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotspot/pending-orders?action=reload" title="Reload">Query</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w100" style="text-align:center">Status</span>
