    ...
    <body id="plans">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/hotel/plans">Plans</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_plans">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/hotel/plans?action=new" title="New Plan">New</a>
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/hotel/plans?action=update" title="Edit Plan">Edit</a>
                    <a class="btn" action="delete" href="<?php echo CONTEXT_PATH ?>/backend/hotel/plans?action=delete" title="Delete Plan">Delete</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotel/plans?action=reload" title="Reload Plan">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w150" style="text-align:center">Hotel</span>
                            <span class="td w150" style="text-align:center">Plan</span>
                            <span class="td w80" name="point" dataColumn="DataColumnTextbox" validation="Number" style="text-align:center">Point</span>
