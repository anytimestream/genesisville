    ...
    <body id="hotels">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/hotel/users">Users</a></li>
            </ul>
            <div class="normosa-ui-datatable" id="datatable_hotels">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/hotel/users?action=new" title="New User">New</a>
                    <a class="btn" action="delete" href="<?php echo CONTEXT_PATH ?>/backend/hotel/users?action=delete" title="Delete User">Delete</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/hotel/users?action=reload" title="Reload User">Reload</a>
