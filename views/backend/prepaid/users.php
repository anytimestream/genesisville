    ...
    <body id="users">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/prepaid/users">Users</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_users">
                <div class="toolbar">
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/users?action=update" title="Edit User">Edit</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/users?action=reload" title="Reload User">Reload</a>
                    <a class="btn" execute="send_sms" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/users?action=update-password" title="Update Password" style="padding: 0 7px;">Update Password</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1600px;">
                        <div class=th>
                            ...
                            <span class="td w120" name="agent" dataColumn="DataColumnSelect" dataSource="_agent" style="text-align:center;">Agent</span>
                            ...
                            <span class="td w80" name="state" dataColumn="DataColumnSelect" dataSource="_state" style="text-align:center;">User State</span>
