...
<html>
    ...
    <body id="orders">
        ...
        <div id="content">
            <ul class="tab">
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/prepaid/orders">Orders</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_orders">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/orders?action=new" title="New Order">New</a>
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/orders?action=update" title="Edit Order">Edit</a>
                    <a class="btn" execute="print_ticket" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/orders?action=print" title="Print">Print</a>
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/orders?action=summary&<?php echo $_GET['url_search'] ?>" title="<?php echo $_GET['summary_url'] ?>">Summary</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/orders?action=reload" title="Reload Orders">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1730px;">
                        <div class=th>
