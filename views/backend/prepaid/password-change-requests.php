...
<html>
    <head>
        ...
        <title>Prepaid | Password Change Requests</title>
    ...
    <body id="password_change_request">
        ...
        <div id="content">
            <ul class="tab">
                ...
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/prepaid/password-change-requests">Password Change Requests</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_password_change_request">
                <div class="toolbar">
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/prepaid/password-change-requests?action=reload" title="Reload">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1500px;">
                        <div class=th>
                            ...
                            <span class="td w80">User ID</span>
                            <span class="td w150">Name</span>
                            <span class="td w150">Password</span>
                        ...
                        <?php require 'password-change-request-reload.php'; ?>
                    </div>
                </div>
            </div>
        </div>
