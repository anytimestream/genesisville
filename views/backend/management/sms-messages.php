...
<html>
    <head>
        ...
        <title>Management | SMS Messages</title>
    ...
    <body id="phone_numbers">
        ...
        <div id="content">
            ...
            <div class="normosa-ui-datatable" id="datatable_sms_messages">
                <div class="toolbar">
                    <a class="btn" action="edit" href="<?php echo CONTEXT_PATH ?>/backend/management/sms-messages?action=update" title="Edit">Edit</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/management/sms-messages?action=reload" title="Reload">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w500" style="text-align:center" name="message" dataColumn="DataColumnTextbox" validation="String" min="2" max="300">Message</span>
                            <span class="td w150" style="text-align:center" name="sender" dataColumn="DataColumnTextbox" validation="String" min="2" max="11">Sender Name</span>
                        </div>
                        <div class=th_fix></div>
                        <?php require 'sms-messages-reload.php'; ?>
                    </div>
                </div>
            </div>
        </div>
