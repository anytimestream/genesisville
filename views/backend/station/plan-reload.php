...
for ($i = 0; $i < $plans->count(); $i++) {
    ...
    <span class="td w150"><?php echo $plans[$i]->getValue('station')?></span>
    <span class="td w150"><?php echo $plans[$i]->getValue('plan')?></span>
    <span class="td w100" style="text-align:right"><?php echo $plans[$i]->getValue('amount')?></span>
    <span class="td w100" style="text-align:right"><?php echo $plans[$i]->getValue('contract_value')?></span>
