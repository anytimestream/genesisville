...
<html>
    ...
    <body id="orders">
        ...
        <div id="content">
            <ul class="tab">
                <li><a class="active" href="<?php echo CONTEXT_PATH; ?>/backend/station/orders">Orders</a></li>
            ...
            <div class="normosa-ui-datatable" id="datatable_orders">
                <div class="toolbar">
                    <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/backend/station/orders?action=summary&<?php echo $_GET['url_search'] ?>" title="<?php echo $_GET['summary_url'] ?>">Summary</a>
                    <a class="btn" execute="send_sms" href="<?php echo CONTEXT_PATH ?>/backend/station/orders?action=send-sms" title="Send SMS">Send SMS</a>
                    <a class="btn" action="reload" href="<?php echo CONTEXT_PATH ?>/backend/station/orders?action=reload" title="Reload Plan">Reload</a>
                ...
                <div class="scrollpane" style="height: 500px;">
                    <div class=content style="min-width:1200px;">
                        <div class=th>
                            ...
                            <span class="td w120" style="text-align:center">Station</span>
