        ...
        <div id="content">
            ...
            <div class="right">
                <div class="normosa-ui-datatable" id="datatable_orders">
                    <div class="toolbar">
                        <a class="btn" action="new" href="<?php echo CONTEXT_PATH ?>/hotel/orders?action=summary&<?php echo $_GET['url_search'] ?>" title="<?php echo $_GET['summary_url'] ?>">Summary</a>
                        <a class="btn" execute="print_ticket" href="<?php echo CONTEXT_PATH ?>/hotel/orders?action=print" title="Print">Print</a>
                    ...
                    <div class="scrollpane" style="height: 500px;">
                        <div class=content style="min-width:1000px;">
                            <div class=th>
                                ...
                                <span class="td w80" style="text-align:center">Point</span>
