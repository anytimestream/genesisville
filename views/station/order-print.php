...
<html>
    ...
    <body id="ticket">
        <div class=ticket>
            <div class="name"><?php echo $_GET['order']->getValue('station') ?></div>
            ...
            <span class="col-1 lh-16">Value:</span><span class="col-2 lh-16">N<?php echo number_format($_GET['order']->getValue('amount'), 2) ?></span><br/>  
            <span class="col-1 lh-16">Access Time:</span><span class="col-2 lh-16"><?php echo $_GET['order']->getValue('uptime') ?></span><br/>
            <span class="col-1 lh-16">Validity:</span><span class="col-2 lh-16"><?php echo $_GET['order']->getValue('validity') ?></span><br/>
