...
for ($i = 0; $i < $orders->count(); $i++) {
    ...
    <span class="td w60" style="text-align:center"><?php echo $orders[$i]->getValue('account_number')?></span>
    <span class="td w120" style="text-align:center"><?php echo $orders[$i]->getValue('plan')?></span>
    <?php
    ...
    ?>
    <span class="td w100" style="text-align:right"><?php echo number_format($orders[$i]->getValue('amount'), 2)?></span>
